...
//   // Ensure the form updates if user loads after first render
//   React.useEffect(() => {
//     if (user) {
//       const freshSettings =
//         (user?.publicMetadata as { settings?: UserSettings })?.settings || {};
...
//       methods.reset({
//         courseNotifications: freshSettings.courseNotifications || false,
//         emailAlerts: freshSettings.emailAlerts || false,
//         smsAlerts: freshSettings.smsAlerts || false,
//         notificationFrequency:
//           freshSettings.notificationFrequency || "daily",
//       });
//     }
//   }, [user, methods]);
